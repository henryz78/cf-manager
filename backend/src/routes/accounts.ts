...
import { getAllAccounts, createAccount, deleteAccount, getAccountById, getAccountByEmail, nameFromEmail, updateAccountStatus, updateAccountId, updateAccountFeatures, updateAccount, AccountInput, listAccountsPaged, AccountListFilter } from '../models/account';
...
router.post('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const input: AccountInput = { name, auth_type, account_id: undefined, enabled_features: req.body.enabled_features };
    if (auth_type === 'token') {
...
router.put('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    input.account_id = fetchedAccountId || account.account_id || undefined;
